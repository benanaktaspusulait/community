...
const sections = [
  ...
  },
  {
    ...
    screens: [
      ...
      { path: '/group', label: 'Topic Group (thread list / "chat")' },
      { path: '/thread', label: 'Thread Detail (replies)' },
  ...
  },
  {
    ...
    screens: [
      ...
      { path: '/create', label: 'Create Help Request' },
      { path: '/report', label: 'Report Modal' },
    ],
  },
  {
    title: '📚 Library',
